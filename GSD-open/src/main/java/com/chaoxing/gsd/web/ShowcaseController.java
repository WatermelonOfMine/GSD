...
public class ShowcaseController {
	 ...
	 * @param endTime 结束时间
	 * @param limitSzie 取前几名
	 * @return
	 */
	@GET
    @RequestMapping("/getSearchCountRanking")
    @ResponseBody
    public BaseResponse getSearchCountRanking(@RequestParam(value = "startTime", required = true) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date startTime, 
	 ...
	 * @param offset 分页查询开始下标，0开始
	 * @param limit 一页查询限制次数
	 * @param isdesc 是否倒叙，0表示升序，1表示倒叙
	 * @return
	 */
	@GET
